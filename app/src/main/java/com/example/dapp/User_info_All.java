...
public class User_info_All extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        CircleImageView edit_user_photo = findViewById(R.id.user_info_edit_photo);
        TextView edit_user_ID = findViewById(R.id.user_info_medical_id);
        TextView edit_user_nickname = findViewById(R.id.user_info_edit_nickname);
        TextView edit_user_loginName = findViewById(R.id.user_info_login_name);
        TextView edit_user_sex = findViewById(R.id.user_info_edit_sex);
        TextView edit_user_birth = findViewById(R.id.user_info_edit_birth);
        TextView edit_user_tall = findViewById(R.id.user_info_edit_tall);
        TextView edit_user_weight = findViewById(R.id.user_info_edit_weight);
        TextView edit_user_career = findViewById(R.id.user_info_edit_career);
        TextView edit_user_intensity = findViewById(R.id.user_info_intensity);
        TextView edit_user_shape = findViewById(R.id.user_info_shape);
        TextView edit_user_weight_expect = findViewById(R.id.user_info_Expect_weight);
        ...
        String get_edit_ID = bundle_from_MA.getString("from_Login_User_id");
